...
Joern in your work. In particular, we cover its installation in
Section [sec:installation] and discuss how code can be imported and
retrieved from the database in Section [sec:importAccess].
Section [sec:performance] offers tips on performance tuning and is
considered a must-read if you plan to run queries on large code bases.
Section [sec:dbOverview] gives an overview of the database contents,,
showing what kind of information Joern makes available for your search
queries. Finally, Section [sec:examples] documents the available
traversals for code analysis and Section [sec:development] contains
...
Importing and Accessing Code {#sec:importAccess}
============================
...
Performance Tuning {#sec:performance}
==================
...
Database Overview {#sec:dbOverview}
=================
...
refer to Section [sec:startNode].

Querying the Database {#sec:examples}
=====================
...
of the graph traversal language Gremlin in Section [sec:gremlin] and
proceed to discuss how to select start nodes from the node index in
Section [sec:startNode]. The remainder of this chapter deals with code
retrieval based on syntax (Section [sec:ast] and [sec:syntaxOnly]),
taint-style queries in Section [sec:taint] and finally, traversals in
the function symbol graph in Section [sec:symbolGraph].
...
Start Node Selection {#sec:startNode}
--------------------
...
Traversing Syntax Trees {#sec:ast}
-----------------------

In the previous section, we outlined how nodes can be selected based on
their properties. As outline in Section [sec:gremlin], these selected
...
Gremlin traversals presented in Section [sec:gremlin]. However,
...
Syntax-Only Descriptions {#sec:syntaxOnly}
------------------------
...
Traversing the Symbol Graph {#sec:symbolGraph}
---------------------------

As outlined in Section [sec:dbOverview], the symbols used and defined by
...
Taint-Style Descriptions {#sec:taint}
------------------------
